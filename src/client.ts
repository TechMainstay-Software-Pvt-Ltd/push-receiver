...
// const FCM_SEND_API =
//   "https://fcm.googleapis.com/v1/projects/tmbillchannel/messages:send";
...
export default class PushReceiver extends EventEmitter {
  ...
  constructor(config: Types.ClientConfig) {
    ...
    this.config = {
      ...
      vapidKey:
        "BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4", // This is default Firebase VAPID key
      persistentIds: [],
  ...
  public emit(
    event: "ON_MESSAGE_RECEIVED",
    data: Types.MessageEnvelope
  ): boolean;
  public emit(
    event: "ON_CREDENTIALS_CHANGE",
    data: Types.EventChangeCredentials
  ): boolean;
  ...
  private startHeartbeat() {
    ...
    this.heartbeatTimer = setTimeout(
      this.sendHeartbeatPing.bind(this),
      this.config.heartbeatIntervalMs
    );
    this.heartbeatTimeout = setTimeout(
      this.socketRetry.bind(this),
